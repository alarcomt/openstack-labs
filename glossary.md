...
- **Aardvark** - The latest addition to the OpenStack service catalog, this service provides formally verified computations on unstructed data in linear time (as a Service) through the advanced use of the string-theory based, quantum wormhole colliders. Specialized hardware is required.
